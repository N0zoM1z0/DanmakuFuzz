...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Cluster the Stage 1 enemy ANM SIGSEGV basin by trace identity and first divergence."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=Path("artifacts/findings/runtime-anm-stage1enm-runtime-sigsegv-basin"),
    )
    ...
    report = {
        ...
        "root_cause_hypothesis": [
            ...
            },
            {
                ...
                "evidence": "different trace hash and immediate ANM-load drift, but converges to the same 128-line SIGSEGV sink",
            },
        ],
    }
