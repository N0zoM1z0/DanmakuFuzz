...
TARGET_ENTRY = "stg7enm.anm"
EXPECTED_RETURN_CODE = -11
EXPECTED_TRACE_LINES = 440
TARGET_MUTANTS = {
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 7 enemy ANM SIGSEGV basin."
    )
    ...
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "runtime-anm-stage7enm-runtime-sigsegv-basin",
    )
...
def main() -> int:
    ...
    baseline_worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="runtime-anm-stage7enm-baseline",
        reuse=True,
    )
    ...
    for mutant_name, expectations in TARGET_MUTANTS.items():
        ...
        worker_prepare = prepare_worker_game_dir(
            ...
            worker_name=f"runtime-anm-stage7enm-{mutant_name}",
            reuse=False,
        )
    ...
    summary = {
        "finding": "runtime/anm-stage7enm-runtime-sigsegv-basin",
