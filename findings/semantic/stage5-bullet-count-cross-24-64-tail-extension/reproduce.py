...
TARGET_MUTANT_NAME = "bullet-count-cross-24-64"
TARGET_MUTANT_PATH = (0, 11)
TARGET_COUNT1_VALUE = 24
TARGET_COUNT2_VALUE = 64
TARGET_ORIGINAL_COUNT1_VALUE = 40
TARGET_ORIGINAL_COUNT2_VALUE = 1
TARGET_OPCODE = 69
TARGET_PAYLOAD_SHA256 = "7463c990f81288b350df99947bf37138edb0e5e197b2bdecde6544e9b9ed45be"
...
EXPECTED_MAX_BULLET_TICK = 510
EXPECTED_FIRST_STAGE_VM_DRIFT_TICK = 1334
EXPECTED_FIRST_TIMELINE_DRIFT_TICK = 1334
EXPECTED_CASE_FINAL = {
    "tick": 1800,
    "game_frame": 1441,
    "score": 387110,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 5 bullet-count-cross=(24,64) tail-extension finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage5-bullet-count-cross-24-64-tail-extension",
    )
...
def main() -> int:
    ...
    worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="stage5-bullet-count-cross-24-64",
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage5-bullet-count-cross-24-64-tail-extension",
