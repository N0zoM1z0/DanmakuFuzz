...
FINDING_NAME = "semantic/replay-coordinated-stage4-borrow-seed-prev-s3-1234-script-drift-basin"
EXPECTED_MUTANT_NAME = "coordinated-borrow-seed-prev-s3-s1234"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the replay-coordinated stage4 borrow-seed-prev-s3-1234 script-drift basin."
    )
    ...
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-replay-coordinated-stage4-borrow-seed-prev-s3-1234-script-drift-basin",
    )
