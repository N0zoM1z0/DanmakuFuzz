...
REPRESENTATIVES = (
    {
        ...
        "payload_sha256": "983135b1223a67b629d4348d79007e400a48c4398ec6d341d0443252b0318f22",
        "trace_sha256": "78e82f5d2b706a0cc9972a81761a5e5a61692859832983b12509c0e6574a9247",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1403,
            "score": 181570,
        ...
        "expected_findings": [
            {"kind": "score-drift", "detail": "tick 319 baseline=2450 case=1950"},
            {"kind": "item-count-drift", "detail": "tick 332 baseline=7 case=1"},
            {"kind": "life-drift", "detail": "tick 342 baseline=1 case=2"},
            ...
            {"kind": "bullet-count-drift", "detail": "tick 1053 baseline=61 case=0"},
            {"kind": "enemy-count-drift", "detail": "tick 1076 baseline=5 case=7"},
        ],
    },
    {
        "name": "shoot-interval-0",
        "value": 0,
        "patch": "payload_shoot_interval_0.json",
        "payload_sha256": "0b4e394da0eaedc9c5f471cd46dff25781e55492110e187d9fed0b969c224706",
        "trace_sha256": "1170423157205e315d06deda1ccd47846424c96148f0cfb21699a2ea7a547cf0",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1403,
            "score": 180940,
    ...
    {
        "name": "shoot-interval-2147483602",
        "value": 2147483602,
        "patch": "payload_shoot_interval_2147483602.json",
        "payload_sha256": "9f1ba3634a172f44ef485b866d835f731b7e7878548c60bf2c6213876f1ac037",
        "trace_sha256": "78e82f5d2b706a0cc9972a81761a5e5a61692859832983b12509c0e6574a9247",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1403,
...
RETAIL_REPRESENTATIVE_NAME = "shoot-interval-2147483602"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 1 cross-value shoot-interval delayed-freeze basin."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage1-shoot-interval-cross-value-delayed-freeze-basin",
    )
...
def main() -> int:
    ...
    worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="stage1-shoot-interval-delayed-freeze-basin",
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage1-shoot-interval-cross-value-delayed-freeze-basin",
