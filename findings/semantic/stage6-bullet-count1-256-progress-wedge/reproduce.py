...
TARGET_MUTANT_NAME = "bullet-count1-256"
TARGET_MUTANT_PATH = (1, 3)
TARGET_COUNT1_VALUE = 256
TARGET_ORIGINAL_COUNT1_VALUE = 6
TARGET_ORIGINAL_COUNT2_VALUE = 2
TARGET_OPCODE = 75
TARGET_PAYLOAD_SHA256 = "d4e94fffdd8bcdb6547f873a5081e8456f9da1710a6b5dc873857a3abaa6dfbd"
...
EXPECTED_FROZEN_FRAME = 1385
EXPECTED_FIRST_FROZEN_TICK = 1385
EXPECTED_FIRST_STAGE_VM_DRIFT_TICK = 1386
EXPECTED_FIRST_TIMELINE_DRIFT_TICK = 1386
EXPECTED_CASE_FINAL = {
    "tick": 1800,
    "game_frame": 1385,
    "score": 991390,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 6 bullet-count1=256 progress-wedge finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage6-bullet-count1-256-progress-wedge",
    )
...
def main() -> int:
    ...
    worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="stage6-bullet-count1-256",
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage6-bullet-count1-256-progress-wedge",
