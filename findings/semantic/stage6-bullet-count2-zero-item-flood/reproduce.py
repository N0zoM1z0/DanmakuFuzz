...
TARGET_MUTANT_NAME = "bullet-count2-zero"
TARGET_MUTANT_PATH = (1, 3)
TARGET_PAYLOAD_SHA256 = "af83ddb14b84ec4caf6731679e1c5a9c132e5501c1bfa203516ab5be8d468eb1"
...
def _target_mutant():
    ...
    mutants = select_mutants(
        ...
        name_filters=["bullet-count2-zero"],
    )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 6 bullet-count2-zero item-flood finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage6-bullet-count2-zero-item-flood",
    )
...
def main() -> int:
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage6-bullet-count2-zero-item-flood",
