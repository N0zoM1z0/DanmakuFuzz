...
TARGET_MUTANT_PATH = (0, 7)
TARGET_PAYLOAD_SHA256 = "dfd55e1d79ee95fcc3678e5e956decddb49998c697d3702e720ede851b624c0f"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 1 shoot-interval-one bullet-storm finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage1-shoot-interval-one-bullet-storm",
    )
...
def main() -> int:
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage1-shoot-interval-one-bullet-storm",
