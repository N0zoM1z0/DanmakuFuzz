...
REPRESENTATIVES = (
    {
        "name": "shoot-interval-192",
        "value": 192,
        "patch": "payload_shoot_interval_192.json",
        "payload_sha256": "d01baa7fc32cc5d861376052dff83f67759089e64ed7e40d5cc07fc3e5e93aba",
        "trace_sha256": "506ca4e6b3eedb5ea3a4b0c0dfeb1f8ffbc02d484cde278b25bde1dc1798df38",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1680,
            "score": 155470,
        ...
        "expected_findings": [
            {"kind": "bullet-count-drift", "detail": "tick 597 baseline=20 case=0"},
            {"kind": "score-drift", "detail": "tick 707 baseline=16260 case=15760"},
            {"kind": "item-count-drift", "detail": "tick 721 baseline=14 case=8"},
            {"kind": "power-drift", "detail": "tick 721 baseline=112 case=128"},
            {"kind": "life-drift", "detail": "tick 731 baseline=1 case=2"},
            {"kind": "stage-script-drift", "detail": "tick 1361 stage_vm.loaded baseline=False case=True"},
            {"kind": "ecl-timeline-drift", "detail": "tick 1361 ecl_timeline.time baseline=1345 case=1361"},
            {"kind": "enemy-count-drift", "detail": "tick 1448 baseline=6 case=4"},
            {"kind": "point-item-drift", "detail": "tick 1662 baseline=0 case=1"},
        ],
    },
    {
        "name": "shoot-interval-2248",
        "value": 2248,
        "patch": "payload_shoot_interval_2248.json",
        "payload_sha256": "b0270036eb35e6aab34c21e31a6695ea29fd94e8d8e8c12281cf1686e92ed798",
        "trace_sha256": "3e55eca9dd3c07503baf3f8617603a0946e367007b355563cdf382ea75f55f36",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1680,
            "score": 241230,
        ...
        "expected_findings": [
            ...
            {"kind": "power-drift", "detail": "tick 721 baseline=112 case=128"},
            {"kind": "life-drift", "detail": "tick 731 baseline=1 case=2"},
            {"kind": "enemy-count-drift", "detail": "tick 766 baseline=8 case=4"},
            {"kind": "point-item-drift", "detail": "tick 1203 baseline=0 case=1"},
            {"kind": "stage-script-drift", "detail": "tick 1361 stage_vm.loaded baseline=False case=True"},
            {"kind": "ecl-timeline-drift", "detail": "tick 1361 ecl_timeline.time baseline=1345 case=1361"},
        ],
    },
)
RETAIL_REPRESENTATIVE_NAME = "shoot-interval-192"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 3 cross-value shoot-interval tail extension."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage3-shoot-interval-cross-value-tail-extension",
    )
...
def main() -> int:
    ...
    worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="stage3-shoot-interval-tail-extension",
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage3-shoot-interval-cross-value-tail-extension",
