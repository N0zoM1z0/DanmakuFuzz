...
TARGET_MUTANT_PATH = (0, 14)
TARGET_PAYLOAD_SHA256 = "5828077a09623f8f35bfd10eaa2a2e6abed349811d02283a2b86eff3ddb77eb9"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 5 jump-offset-zero route-warp finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage5-jump-offset-zero-route-warp",
    )
...
def main() -> int:
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage5-jump-offset-zero-route-warp",
