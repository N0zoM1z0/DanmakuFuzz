...
EXPECTED_FINDINGS = [
    {"kind": "bullet-count-drift", "detail": "tick 530 baseline=400 case=80"},
]
...
EXPECTED_SHARED_TRACE_SHA256 = "1914a4b2e1f4967d97613d72b5330949f8e96d24b7177dd496a0f3d6783b09d9"
EXPECTED_SHARED_SINK_SIGNATURE = "6132a79027e8b6d52ae245a28ae8c5edcdc14dd6e1af8954751087dcb52461eb"
...
EXPECTED_FIRST_DIVERGENCE_TICK = 520
EXPECTED_FIRST_DIVERGENCE_KEYS = ["enemies"]
RETAIL_REPRESENTATIVE_NAME = "jump-offset-neg222"

REPRESENTATIVES = (
    {
        "name": "jump-offset-neg222",
        "value": -222,
        "patch": "payload_jump_offset_neg222.json",
        "payload_sha256": "707599aa8197dc8f48c71379a1fcf76efda144bfb88e822d346132eb92e3c234",
    },
    {
        "name": "jump-offset-neg1248",
        "value": -1248,
        "patch": "payload_jump_offset_neg1248.json",
        "payload_sha256": "d70c45df60fe8039670c9184d00b6c007dcd476cd2dda4189bd560a3529647b1",
    },
    {
        "name": "jump-offset-1792",
        "value": 1792,
        "patch": "payload_jump_offset_1792.json",
        "payload_sha256": "af4b0a5b3e7805cc4b7d1a699020b47cedd1fd38e13b7b0888774d477aab5bff",
    },
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 5 shared jump-offset route-warp basin."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage5-jump-offset-shared-route-warp-basin",
    )
...
def main() -> int:
    ...
    for case_index, rep in enumerate(REPRESENTATIVES, start=1):
        ...
        sink_signature = _signature(_sink_snapshot(divergence_record))
        if sink_signature != EXPECTED_SHARED_SINK_SIGNATURE:
            raise RuntimeError(
                f"{rep['name']} sink signature drifted: expected {EXPECTED_SHARED_SINK_SIGNATURE}, got {sink_signature}"
            )
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage5-jump-offset-shared-route-warp-basin",
        ...
        "headless": {
            ...
            "shared_sink_signature": EXPECTED_SHARED_SINK_SIGNATURE,
        ...
        "source_grid": {
            ...
            "family_key": "bullet-count-drift:tick 530 baseline=400 case=80|ir",
            "cases": 3,
        },
        "trace_basin_summary": str(
            (ARTIFACTS_DIR / "semantic-trace-basins" / "20260822T-stage5-jump-offset-shared-route-warp-basin" / "summary.json").resolve()
        ),
    }
