...
REPRESENTATIVES = (
    {
        "name": "shoot-interval-45",
        "value": 45,
        "patch": "payload_shoot_interval_45.json",
        "payload_sha256": "fe5aebbefed46b3bdc6bdd9bc781f19d9c6fdf7103a3a79dd253acb16054abe3",
        "trace_sha256": "63f84aea6541f44ca7a9c653608c5693d7e990d04cb452deec244ef5398cd39f",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1225,
            "score": 485330,
        ...
        "expected_findings": [
            {"kind": "bullet-count-drift", "detail": "tick 502 baseline=124 case=188"},
            {"kind": "score-drift", "detail": "tick 860 baseline=299820 case=300320"},
            {"kind": "enemy-count-drift", "detail": "tick 1106 baseline=9 case=7"},
            {"kind": "stage-script-drift", "detail": "tick 1241 stage_vm.script_time baseline=1226 case=1225"},
            {"kind": "ecl-timeline-drift", "detail": "tick 1241 ecl_timeline.time baseline=1226 case=1225"},
        ],
    },
    {
        "name": "shoot-interval-179",
        "value": 179,
        "patch": "payload_shoot_interval_179.json",
        "payload_sha256": "fecfa31931995d6328b0352d6962ff75cfa1b11b7e74b7a0c068dbda75d91461",
        "trace_sha256": "d1df850ce9b948300c486fe7c18494ad8064e1e3c2444c03d98a4ef37509fbcf",
        "expected_tail": {
            "tick": 1800,
            "game_frame": 1212,
            "score": 571570,
        ...
        "expected_findings": [
            {"kind": "score-drift", "detail": "tick 544 baseline=19550 case=19000"},
            {"kind": "enemy-count-drift", "detail": "tick 629 baseline=14 case=16"},
            {"kind": "bullet-count-drift", "detail": "tick 758 baseline=141 case=74"},
            {"kind": "power-drift", "detail": "tick 874 baseline=40 case=63"},
            {"kind": "life-drift", "detail": "tick 884 baseline=0 case=1"},
            {"kind": "item-count-drift", "detail": "tick 891 baseline=24 case=29"},
            {"kind": "point-item-drift", "detail": "tick 966 baseline=3 case=5"},
...
RETAIL_REPRESENTATIVE_NAME = "shoot-interval-179"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 2 cross-value shoot-interval tail split."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage2-shoot-interval-cross-value-tail-split",
    )
...
def main() -> int:
    ...
    worker_prepare = prepare_worker_game_dir(
        ...
        worker_name="stage2-shoot-interval-tail-split",
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage2-shoot-interval-cross-value-tail-split",
