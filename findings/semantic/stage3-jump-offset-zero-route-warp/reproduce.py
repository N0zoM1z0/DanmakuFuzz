...
TARGET_MUTANT_NAME = "jump-offset-zero"
TARGET_MUTANT_PATH = (4, 19)
TARGET_PAYLOAD_SHA256 = "1ac87273c4ff4c6ada358939c8ad5278cbca99eec8194a6b7bf0a5360eacfb98"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Reproduce the Stage 3 jump-offset-zero route-warp finding."
    )
    parser.add_argument(
        "--artifact-dir",
        type=Path,
        default=ARTIFACTS_DIR / "findings" / "semantic-stage3-jump-offset-zero-route-warp",
    )
...
def main() -> int:
    ...
    summary: dict[str, object] = {
        "finding": "semantic/stage3-jump-offset-zero-route-warp",
