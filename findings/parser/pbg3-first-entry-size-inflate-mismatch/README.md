...
- per-case result:
  `artifacts/parser-pbg3/20260822T-full-a/0010-first-entry-size-inflate/result.json`
- standalone reproduction summary:
  `artifacts/findings/parser-pbg3-first-entry-size-inflate-mismatch/summary.json`
