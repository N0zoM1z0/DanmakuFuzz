...
- per-case result:
  `artifacts/parser-pbg3/20260822T-full-a/0014-first-entry-empty-payload/result.json`
- standalone reproduction summary:
  `artifacts/findings/parser-pbg3-first-entry-empty-payload-acceptance/summary.json`
